        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              <img src="/bnn-logo.png" alt="Logo BNN" className="h-12 w-auto md:h-12" />
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.instagram.com/infobnn_kota_sawahlunto/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/10 hover:bg-primary transition-colors duration-300" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/bnnksawahlunto/?locale=id_ID" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/10 hover:bg-primary transition-colors duration-300" aria-label="Facebook">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385h-3.047v-3.47h3.047v-2.642c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953h-1.514c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385c5.736-.9 10.124-5.864 10.124-11.854z"/></svg>
              </a>
              <a href="https://www.youtube.com/@humasbnnksawahlunto2129" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/10 hover:bg-primary transition-colors duration-300" aria-label="YouTube">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href="https://www.youtube.com/@humasbnnksawahlunto2129" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/10 hover:bg-primary transition-colors duration-300" aria-label="Twitter / X">
              ...
              {quickLinks.map((link) => (
                <li key={link.to}>
                  <Link to={link.to} className="text-sm text-white/50 hover:text-secondary-container transition-colors duration-300 flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-white group-hover:bg-secondary-container transition-colors"></span>
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                <span className="material-symbols-outlined text-white text-[20px] mt-0.5 shrink-0" style={{fontVariationSettings: "'FILL' 1"}}>location_on</span>
                <span className="text-sm text-white/50 leading-relaxed">
                  Lubang Panjang, Kec. Barangin, Kota Sawahlunto, Sumatera Barat 27422
                </span>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-white text-[20px] shrink-0" style={{fontVariationSettings: "'FILL' 1"}}>call</span>
                <a href="tel:+6281276006723" className="text-sm text-white/50 hover:text-secondary-container transition-colors">081276006723 </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-white text-[20px] shrink-0" style={{fontVariationSettings: "'FILL' 1"}}>mail</span>
                <a href="mailto:bnn.sawahlunto@bnn.go.id" className="text-sm text-white/50 hover:text-secondary-container transition-colors">bnnkota_sawahlunto@bnn.go.id </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-white text-[20px] shrink-0" style={{fontVariationSettings: "'FILL' 1"}}>schedule</span>
